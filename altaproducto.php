<form class="mt-3" method="POST" action="" enctype="multipart/form-data" id="altaproducto">
...
<?php
    ...
    if ($_POST) {
      ...
      $mysqli->query("insert into producto values ('" . $referencia . "','" . $nombre . "','" . $stock . "','" . $precio . "','" . $oferta . "','" . $novedad . "','" . $actual . "','" . $fabricacion . "','" . $descripcion . "','" . $imagen . "'," . $categoria . "," . $precio_oferta . ",'0')");
